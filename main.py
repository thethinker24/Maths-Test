...
def generate_value(doc, doc2, difficulty):
    ...
    if difficulty == 1:
        ...
        # Get first number
        number1 = int((random.random() * 11))
        number1_str = prep_str(str(number1)) # Create the first string
        number2 = int((random.random() * 11))
    ...
    if difficulty == 2:
        ...
        # Get first number
        number1 = int((random.random() * 50)) + 50
        number1_str = prep_str(str(number1)) # Create the first string
    ...
    if difficulty == 3:
        ...
        # Get first number
        number1 = int((random.random() * 101))
        number1_str = prep_str(str(number1)) # Create the first string
        number2 = int((random.random() * 101))
        number2_str = prep_str(str(number2)) # Create the first string
    ...
    if difficulty == 6:
        ...
        # Get first number
        number1 = int((random.random() * 13))
        number1_str = prep_str(str(number1)) # Create the first string
        number2 = int((random.random() * 13))
        number2_str = prep_str(str(number2)) # Create the first string
    ...
    if difficulty == 9:
        ...
        # Get first number
        number1 = int((random.random() * 101)) + 1 # need the + 1 so no division by 0
        number1_str = prep_str(str(number1)) # Create the first string
        number2 = number1 * int((random.random() * 11))
        number2_str = prep_str(str(number2)) # Create the first string
...
if __name__ == '__main__':
    ...
    current_directory = '/home/thinker/Sheets/Math_Worksheet_Generator'
    output_directory  = '/home/thinker/Sheets/output'
